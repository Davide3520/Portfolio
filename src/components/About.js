    ...
    <section id="about">
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        ...
        <img
            ...
            alt="hero"
            src="https://images.unsplash.com/photo-1578185708140-55c94bb9426f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YmVhdXRpZnVsJTIwZmxvd2Vyc3xlbnwwfHwwfHw%3D&w=1000&q=80"
          />
        </div>
      </div>
    </section>
